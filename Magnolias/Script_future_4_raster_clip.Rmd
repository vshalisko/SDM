...
prefijo_archivo <- "wc2.1_2.5m_CanESM5_ssp245_2081-2100"
input_path <- "D:/Downloads_bak/Climond2/wc2.1_2.5m_full_CanESM5_ssp245_2081-2100/"
output_path <- "D:/Downloads_bak/Climond2/wc2.1_2.5m_clip_CanESM5_ssp245_2081-2100/"
```
...
```{r}
## Read al rasters
my_stack <- stack(paste0(input_path,"wc2.1_2.5m_tmin_CanESM5_ssp245_2081-2100.tif"))
...
```{r}
## Read al rasters
my_stack <- stack(paste0(input_path,"wc2.1_2.5m_tmax_CanESM5_ssp245_2081-2100.tif"))
...
```{r}
## Read al rasters
my_stack <- stack(paste0(input_path,"wc2.1_2.5m_prec_CanESM5_ssp245_2081-2100.tif"))
...
```{r}
## Read al rasters
my_stack <- stack(paste0(input_path,"wc2.1_2.5m_bioc_CanESM5_ssp245_2081-2100.tif"))
...
writeRaster(stack_bio19, filename = "future_4_stack_bio19.tif", datatype = "FLT4S",format = "GTiff", overwrite = TRUE) 
