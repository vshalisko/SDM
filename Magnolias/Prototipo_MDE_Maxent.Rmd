...
especie <- "Magnolia pugana"

## Prefijo del las capas de salida
especie_prefijo <- "Magnolia_pugana"

## Nombre del archivo con registro de ocurrencias
nombre_ocurrencias <- "BasedatosMpuganaJunio19.csv"

## Nombre del archivo con el conjunto de raster (predictors)
nombre_rasterstack <- "current_stack_bio19.tif"


## iteraciones de validacion cruzada
cross_validation_lenght <- 2
```
...
## 4) Generar 1000 puntos aleatorios para muestreo de la variabilidad ambiental en zona de tierra firme
...
for (i in 1:cross_validation_lenght){
  ...
  ocurrencias_especie <- ocurrencias[ocurrencias$Especie == "Magnolia pugana",c("Especie","Long","Lat")]
...
## 9) Predicción en validación cruzada
...
for (i in 1:cross_validation_lenght){
  ...
  writeRaster(prediccion, 
              filename = paste(especie_prefijo,"_probabilidad_32bits_iteracion_",
                               i,".tif",sep = ""), 
 ...
 plot(prediccion_presencia, legend = FALSE,
  ...
  writeRaster(prediccion_presencia, 
              filename = paste(especie_prefijo,"_presencia_16bits_iteracion_",
                               i,".tif", sep = ""), 
